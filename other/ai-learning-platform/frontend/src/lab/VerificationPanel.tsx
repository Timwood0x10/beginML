  ...
  return (
    ...
    >
      ...
      <span className="text-caption text-on-surface-variant dark:text-outline group-hover:text-primary dark:group-hover:text-inverse-primary transition truncate">
        {label}
        <span
          className="material-symbols-outlined align-middle ml-1"
          style={{ fontSize: 13 }}
        >
          open_in_new
        </span>
      ...
      <div className="mb-3">
        ...
        <div className="flex flex-col gap-2">
          {entry.claims.map((c, i) => (
            <div
              key={i}
              className="rounded-xl border border-outline-variant/40 dark:border-white/10 bg-surface-container dark:bg-white/5 p-4"
            >
              <div className="flex items-start gap-2">
                <span className="font-mono text-caption text-outline mt-0.5 shrink-0">
                  #{i + 1}
                </span>

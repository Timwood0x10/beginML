...
const BELKIN: VerificationSource = {
  kind: "paper",
  title:
    "Reconciling modern machine-learning practice and the classical bias–variance trade-off（Belkin et al., 2019, arXiv:1812.11118）",
  titleEn:
    "Reconciling modern machine-learning practice and the classical bias–variance trade-off (Belkin et al., 2019, arXiv:1812.11118)",
...
const NAKKIRAN: VerificationSource = {
  kind: "paper",
  title:
    "Deep Double Descent: Where Bigger Models and More Data Hurt（Nakkiran et al., 2019, arXiv:1912.02292）",
  titleEn:
    "Deep Double Descent: Where Bigger Models and More Data Hurt (Nakkiran et al., 2019, arXiv:1912.02292)",
...
const DOMINGOS: VerificationSource = {
  kind: "paper",
  title:
    "A Unified Bias-Variance Decomposition for Zero-One and Squared Loss（Domingos, AAAI 2000）",
  titleEn:
    "A Unified Bias-Variance Decomposition for Zero-One and Squared Loss (Domingos, AAAI 2000)",
...
const BITNET: VerificationSource = {
  kind: "paper",
  title:
    "BitNet: Scaling 1-bit Transformers for Large Language Models（Wang et al., 2023, arXiv:2310.11453）",
  titleEn:
    "BitNet: Scaling 1-bit Transformers for Large Language Models (Wang et al., 2023, arXiv:2310.11453)",
...
const BITNET_158: VerificationSource = {
  kind: "paper",
  title:
    "The Era of 1-bit LLMs: All Large Language Models are in 1.58 Bits（Ma et al., 2024, arXiv:2402.17764）",
  titleEn:
    "The Era of 1-bit LLMs: All Large Language Models are in 1.58 Bits (Ma et al., 2024, arXiv:2402.17764)",
...
const RESNET: VerificationSource = {
  kind: "paper",
  title:
    "Deep Residual Learning for Image Recognition（He et al., 2016, arXiv:1512.03385）",
  titleEn:
    "Deep Residual Learning for Image Recognition (He et al., 2016, arXiv:1512.03385)",
...
const SWITCH: VerificationSource = {
  kind: "paper",
  title:
    "Switch Transformers: Scaling to Trillion Parameter Models（Fedus, Zoph & Shazeer, 2021, arXiv:2101.03961）",
  titleEn:
    "Switch Transformers: Scaling to Trillion Parameter Models (Fedus, Zoph & Shazeer, 2021, arXiv:2101.03961)",

...
export const PALETTES: PaletteMeta[] = [
  {
    ...
    tideGradient: {
      light: 'linear-gradient(to bottom, rgba(247,240,227,0.55) 0%, #EAD8BF 35%, #D9C4A0 100%)',
  ...
  },
  {
    ...
    tideGradient: {
      light: 'linear-gradient(to bottom, rgba(234,232,220,0.55) 0%, #D6DDBD 35%, #B5C09A 100%)',
  ...
  },
  {
    ...
    tideGradient: {
      light: 'linear-gradient(to bottom, rgba(243,246,244,0.55) 0%, #C4DED7 35%, #9DBED4 100%)',
  ...
  },
  {
    ...
    tideGradient: {
      light: 'linear-gradient(to bottom, rgba(242,245,241,0.55) 0%, #BFD5CA 35%, #9CBDB0 100%)',
  ...
  },
  {
    ...
    tideGradient: {
      light: 'linear-gradient(to bottom, rgba(243,244,242,0.55) 0%, #C4D5DF 35%, #D4C2B4 100%)',
  ...
  },
  {
    ...
    tideGradient: {
      light: 'linear-gradient(to bottom, rgba(241,243,239,0.55) 0%, #C9D6B6 35%, #A9BB9C 100%)',

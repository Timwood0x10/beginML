...
export const zh: UIDict = {
  ...
  home: {
    ...
    title2: "通向深入理解。",
    subtitle:
      "围绕 AI 的数学、架构与前沿的交互式笔记——可搜索、互联互通，由 scikit-learn 构建语义地图。",
    browseCta: "浏览资料库",
    mapCta: "打开知识地图",
    notes: "篇笔记",
    readingTime: "阅读时长",
    ...
    resSearchTitle: "语义搜索",
    resSearchDesc:
      "由 scikit-learn 驱动的 TF-IDF 搜索，按含义而非关键词找笔记。",
    resMapTitle: "知识地图",
  ...
  path: {
    ...
    phases: {
      math: {
        phase: "第一阶段",
        title: "数学基础",
        blurb: "微积分、线性代数、概率与优化——每个模型之下的基石。",
      },
      attention: {
        phase: "第二阶段",
        title: "自注意力与 Transformer",
        blurb: "从缩放点积注意力到多头、编码器、解码器与 RoPE。",
      },
      hybrid: {
        phase: "第三阶段",
        title: "混合与前沿架构",
        blurb: "MoE、Mamba/SSM、MLA、MTP、量化与 Transformer 之后的推理。",
      },
      paper: {
        phase: "第四阶段",
        title: "研究论文细读",
        blurb: "带批注的论文与实证研究，与基础并读。",
      },
      agent: {
        phase: "第五阶段",
        title: "Agent 工程",
        blurb: "从零构建 Agent：工具调用、记忆、规划与多智能体协作。",
      },
      general: {
        phase: "参考",
        title: "综合笔记",
  ...
  map: {
    title: "知识地图",
    subtitle:
      "每篇笔记按内容的 TF-IDF 向量做多维缩放定位——相邻即相似。拖拽平移，滚轮缩放，点击阅读。",
    reset: "重置视图",
    all: "全部",
    hint: "拖拽平移 · 滚轮缩放",
    open: "点击打开",
...
export const en: UIDict = {
  ...
  home: {
    ...
    subtitle:
      "Interactive notes on the mathematics, architecture and frontiers of modern AI — searchable, interconnected, mapped with scikit-learn.",
    ...
    resSearchDesc:
      "TF-IDF search powered by scikit-learn finds notes by meaning, not just keywords.",
    resMapTitle: "Knowledge map",
    resMapDesc:
      "A 2D map of every note, positioned by multi-dimensional scaling of their content.",
    resPathTitle: "Guided path",
    resPathDesc:
      "A timeline through the notes — from calculus to hybrid architectures.",
    go: "Explore",
    words: "words",
    categoryNames: {
      math: "Mathematics",
    ...
    categoryBlurbs: {
      ...
      attention:
        "Self-attention, multi-head, encoders, decoders, RoPE & inference.",
      hybrid:
        "MoE, Mamba, MLA, quantization and the post-Transformer frontier.",
      paper: "Annotated research papers and close readings.",
      agent:
        "Building an Agent from scratch: tools, memory, planning & multi-agent collaboration.",
  ...
  browse: {
    title: "Library",
    subtitle:
      "Semantic search powered by scikit-learn, browsing every note across subjects.",
  ...
  path: {
    ...
    subtitle:
      "Notes arranged in four phases — foundations first, then architectures, then the frontier.",
    notes: "notes",
    startHere: "Start here",
    phases: {
      math: {
        ...
        blurb:
          "Calculus, linear algebra, probability and optimization — the bedrock beneath every model.",
      },
      attention: {
        phase: "Phase II",
        title: "Self-attention & Transformers",
        blurb:
          "From scaled dot-product attention to multi-head, encoders, decoders and RoPE.",
      },
      hybrid: {
        phase: "Phase III",
        title: "Hybrid & frontier architectures",
        blurb:
          "MoE, Mamba/SSMs, MLA, MTP, quantization and post-Transformer reasoning.",
      },
      paper: {
        phase: "Phase IV",
        title: "Research close-readings",
        blurb:
          "Annotated papers and empirical studies, read alongside the foundations.",
      },
      agent: {
        phase: "Phase V",
  ...
  map: {
    title: "Knowledge map",
    subtitle:
      "Every note is placed by multi-dimensional scaling of its TF-IDF vector — nearby notes discuss similar ideas. Drag to pan, scroll to zoom, click to read.",
    reset: "Reset view",
    all: "All",

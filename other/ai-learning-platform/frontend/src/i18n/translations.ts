...
export const zh: UIDict = {
  nav: { roadmap: '学习路线', library: '资料库', path: '学习路径', map: '知识地图', lab: '数学实验室' },
  ...
  home: {
    ...
    go: '探索',
    words: '字数',
    categoryNames: { math: '数学', attention: '自注意力', hybrid: '混合架构', paper: '研究论文', general: '综合' },
    categoryBlurbs: {
...
export const en: UIDict = {
  nav: { roadmap: 'Roadmap', library: 'Library', path: 'Learning Path', map: 'Knowledge Map', lab: 'Math Lab' },
  ...
  home: {
    ...
    go: 'Explore',
    words: 'words',
    categoryNames: { math: 'Mathematics', attention: 'Self-Attention', hybrid: 'Hybrid Models', paper: 'Research Papers', general: 'General' },
    categoryBlurbs: {

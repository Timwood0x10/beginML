...
export function ErrorState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
      ...
      <p className="text-body-lg text-on-surface dark:text-dark-on-surface max-w-md">
        {message}
      </p>
      {onRetry && (
        <button
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-3 text-center text-on-surface-variant dark:text-outline">
      ...
      <h3 className="font-headline text-headline-lg-mobile text-on-surface dark:text-dark-on-surface">
        {title}
      </h3>

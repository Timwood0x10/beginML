...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface dark:bg-dark-surface text-on-surface dark:text-dark-on-surface relative overflow-x-hidden">
      ...
      <footer className="w-full max-w-container-max mx-auto px-gutter py-10 border-t border-outline-variant/50 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-caption text-on-surface-variant dark:text-outline relative z-10">

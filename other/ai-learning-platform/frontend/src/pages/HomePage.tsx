    ...
    <div className="flex flex-col gap-12">
      ...
      <header className="flex flex-col gap-4 pt-2 md:pt-6">
        ...
        <h1 className="font-headline text-headline-lg-mobile md:text-headline-xl text-on-surface dark:text-inverse-on-surface max-w-3xl leading-tight">
          {t.home.title1}{" "}
          <span className="italic text-primary dark:text-inverse-primary">
            {t.home.title2}
          </span>
        </h1>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          icon="schedule"
          value={`${totalHours}h`}
          label={t.home.readingTime}
        />
        <StatCard
          icon="category"
          value={stats.categories.length.toString()}
          label={t.home.subjects}
        />
        <StatCard
          icon="functions"
...
function StatCard({
  ...
  return (
    <div className="bg-surface-container-low dark:bg-dark-surface-elevated rounded-2xl p-5 border border-outline-variant/40 dark:border-white/10">
      <span
        className="material-symbols-outlined text-primary dark:text-inverse-primary mb-3"
        style={{ fontSize: 24 }}
      >
        {icon}
      </span>
      <div className="font-headline text-3xl font-bold text-on-surface dark:text-inverse-on-surface">
        {value}
      </div>
      <div className="text-caption text-on-surface-variant dark:text-outline uppercase tracking-wider mt-1">
        {label}
      </div>
    </div>
  );
...
function BentoCard({
  ...
  return (
    ...
    >
      ...
      <div>
        <h4 className="font-headline text-lg font-bold text-on-surface dark:text-inverse-on-surface mb-1">
          {title}
        </h4>
        <p className="text-body-md text-on-surface-variant dark:text-outline leading-relaxed">
          {description}
